<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" row-key="tableId">
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if(row.genType === "1") {
        ...
        this.$download.zip("/tool/gen/batchGenCode?tables=" + tableNames, "jiaoyin");
      }
    },
    /** 同步数据库操作 */
    handleSynchDb(row) {
