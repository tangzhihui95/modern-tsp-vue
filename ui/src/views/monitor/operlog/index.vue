<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="系统模块" prop="title" label-width="115px">
        <!-- <el-input
      ...
      <el-form-item label="操作人员" prop="operName" label-width="115px">
        <el-input
      ...
      <el-form-item label="类型" prop="businessType" label-width="115px">
        <el-select
      ...
      <el-form-item label="操作时间" label-width="115px">
        <el-date-picker
          v-model="dateRange"
          size="small"
          style="width: 350px"
...
export default {
  ...
  methods: {
    ...
    // 系统模块下拉列表
    getOptions() {
      options(this.queryParams.title).then((res) => {
