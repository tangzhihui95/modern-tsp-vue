<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange" row-key="jobId">
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br />Class类调用示例：com.jiaoyin.web.quartz.task.RyTask.ryParams('ry')
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出定时任务数据项？').then(() => {
